...
-- -----------------------------------------------------
-- Table `db_starquest`.`perguntas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_starquest`.`perguntas` (
  `id` INT UNSIGNED ZEROFILL NOT NULL COMMENT 'Campo feito para a identificação das perguntas.',
  `perguntas` TEXT(120) NOT NULL COMMENT 'Campo feito para armazenar as perguntas.',
  `alternativa_a` TEXT(120) NOT NULL COMMENT 'Campo feito para armazenar as alternativas.',
  `alternativa_b` TEXT(120) NOT NULL COMMENT 'Campo feito para armazenar as alternativas.',
  `alternativa_c` TEXT(120) NOT NULL COMMENT 'Campo feito para armazenar as alternativas.',
  `alternativa_correta` CHAR(1) NOT NULL COMMENT 'Campo feito para armazenar as alternativas.',
  `tema` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Tabela para armazenar as perguntas, Juliana que mandou.';
