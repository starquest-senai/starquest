...
<body>
	...
	function at_prog (){
			...
			xmlhttp = new XMLHttpRequest();
				...
				xmlhttp.open("GET", "banco_de_fases.php?jogadores_usuario=" + nome + "&fase=" + faseGlobal + "&pontuacao=" + scoreGlobal, true);
				xmlhttp.send();
	...
	function myTimer() {
		...
		<div id="playjogo">		
			<img id="playjogo" src="img/play-icon_342x342.png" onclick="playJogo(), at_prog()">			
		</div>
