    ...
    <form class="form-signin" action="pagina_usuario_editar.php" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="nome_completo" class="form-control" placeholder="" disabled>
            </div>
            <div class="form-group col-md-6">
                <label for="inputEmail4" style="font-weight: bold">Email</label>
                <input type="email" class="form-control" id="inputEmail4" placeholder="" disabled>
            </div>
            <div class="form-group col-md-6">
                <label for="usuario" style="font-weight: bold">Nome de usuário</label><br>
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">@</span>
                    <input type="text" class="form-control" id="usuario" placeholder="" aria-label="Username" aria-describedby="basic-addon1" disabled>
                </div>
            </div>
            <div class="form-group col-md-6">
                <label for="data_nascimento" style="font-weight: bold">Data de nascimento</label><br>
                <input class="form-group col-md-6" id="data_nascimento" name="" type="text" disabled>
            </div>
            <div class="form-group col-md-6">
            ...
            <button class="btn btn-sm btn-primary btn-block" type="submit" onclick="">Editar</button>
